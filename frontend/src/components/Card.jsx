      ...
      <div className="flex flex-col p-5">
        ...
        <div>
          ...
          <div className="flex justify-between mb-2">
            ...
            <p className="italic">{post?.author?.email} </p>
          </div>
          <hr />
        </div>
        ...
        >
          ...
          <div className="flex space-x-5 my-5">
            <div className="relative">
              ...
              />
              <div className="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-3 -right-4 dark:border-gray-900">
                {post?.like_count}
              </div>
            </div>
            <div className="relative">
